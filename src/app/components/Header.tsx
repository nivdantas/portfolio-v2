  ...
  return (
    <header className="flex justify-end mr-4 sticky z-50 top-0">
      ...
      <button
        ...
        className="text-xs lg:text-sm xl:text-lg text-site-800 dark:text-white hover-underline px-2 py-1 opacity-50 mt-4"
      >
        EN
      </button>
      <button
      ...
      >
        <svg
          ...
          className="size-5 lg:size-7 mx-2 hidden mt-4"
