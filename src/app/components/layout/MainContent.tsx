            ...
            <div className="flex flex-col justify-center">
                <ScrollReveal delay={200}>
                    <section className="md:mr-90 2xl:mr-15 lg:mr-5 xl:mb-13">
                        ...
                        <div className="grid grid-cols-[2.5fr_1fr] gap-6 mt-6 min-w-0 shrink-0">
                            ...
                            <h3 className="font-poppins text-[7px] md:text-xs text-center font-medium xl:text-lg">2021 -
                                2024</h3>
                        </div>
                        ...
                        <div className="grid grid-cols-[2.5fr_1fr] gap-6 mt-6 min-w-0 shrink-0">
                            ...
                            <h3 className="font-poppins text-[7px] md:text-xs xl:text-lg text-center font-medium">2026 -
                                Now</h3>
                        </div>
                    ...
                    <section className="mt-5 md:mr-90 2xl:mr-15 lg:mr-5">
                        ...
                        <div className="grid grid-cols-[2.5fr_1fr] gap-6 mt-5 min-w-0 shrink-0">
                            ...
                            <h3 className="font-poppins text-[7px] md:text-xs text-center font-medium xl:text-lg">2020 -
                                2025</h3>
                        </div>
                ...
                <ScrollReveal delay={200}>
                    <section id="projects" className="mt-10 md:mt-40">
                        ...
                        <article
                            className="md:grid xl:grid xl:grid-cols-3 md:grid-cols-2 md:gap-4 mt-4 mr-30 justify-items-stretch">
                            {portfolioContent}
                        </article>
                    </section>
                </ScrollReveal>
