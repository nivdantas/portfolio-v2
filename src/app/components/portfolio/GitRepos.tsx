      ...
      {filtered.map((r, i) => {
        ...
        return (
          <a
            ...
            className={`group relative md:even:justify-self-end xl:even:justify-self-auto md:h-[240px] xl:h-[280px] bg-site-800 dark:bg-site-600 rounded-[10px] overflow-hidden flex flex-col justify-end p-4 hover:shadow-xl transition-all duration-500 ${
              i >= 3 ? "hidden md:flex" : ""
            } ${i > 0 ? "mt-5 md:mt-0" : ""}`}
          >
            {/* Overlay gradient */}
